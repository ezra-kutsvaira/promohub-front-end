      ...
      <main className="container mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card><CardHeader><CardTitle>Promotion management</CardTitle></CardHeader><CardContent className="space-y-2">
            <Button className="w-full" variant="outline" onClick={() => execute(() => api.createPromotion({ businessId: toId(), categoryId: 1, title: "Test promotion", description: notes || "Smoke test", imageUrl: "", startDate: new Date().toISOString(), endDate: new Date(Date.now() + 86400000).toISOString(), promoCode: "SMOKE", discountType: "PERCENT", discountValue: 10, termsAndConditions: "Test", location: "Harare" }), show)}>Create promotion</Button>
            <Button className="w-full" variant="outline" onClick={() => execute(() => api.updatePromotion(toId(), { businessId: toId(), categoryId: 1, title: "Updated promotion", description: notes || "Updated", imageUrl: "", startDate: new Date().toISOString(), endDate: new Date(Date.now() + 172800000).toISOString(), promoCode: "SMOKE2", discountType: "PERCENT", discountValue: 15, termsAndConditions: "Updated", location: "Harare" }), show)}>Update promotion</Button>
